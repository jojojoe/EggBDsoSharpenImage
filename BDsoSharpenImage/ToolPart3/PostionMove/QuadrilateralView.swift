...
final class QuadrilateralView: UIView {
    ...
    public var editable = false {
        didSet {
            ...
            quadLayer.fillColor = editable ? UIColor(white: 0.0, alpha: 0.4).cgColor : UIColor(red: 143/255, green: 181/255, blue: 255/255, alpha: 0.4).cgColor
...
//            quadLayer.fillColor = editable ? UIColor(white: 0.0, alpha: 0.6).cgColor : UIColor(white: 1.0, alpha: 0.5).cgColor
    ...
    private var isHighlighted = false {
        didSet (oldValue) {
            ...
            quadLayer.fillColor = isHighlighted ? UIColor.clear.cgColor : UIColor(white: 0.0, alpha: 0.4).cgColor
            if isHighlighted {
